...
################################################################################################
# USAGE:
# 1. Modify this file as required (i.e. choosing which libraries to install) and place in home directory (e.g. /Users/user_name/)
...
# PETSc:
    ...
    # This means the same PETSc build can be used for multiple Firedrake venv's
